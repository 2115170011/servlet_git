    ...
    <center>
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="650" height="300">
           	...
           	<c:forEach items="${list}" var="user">
           		<tr><td align="center">${user.id}</td><td>${user.userName}</td><td><a href="/toUserUpdateServlet?userid=${user.id }">修改</a>|<a href="/userDeleteServlet?userid=${user.id }">删除</a></td></tr>
           	</c:forEach>
